<%@ Page Title="" Language="C#" MasterPageFile="~/Salons/Salons.Master" AutoEventWireup="true" CodeBehind="Services.aspx.cs" Inherits="Beautify.Salons.WebForm2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphPageContent" runat="server">
     <!-- eCommerce Products Header -->
                        ...
                        <div class="row text-center">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <asp:LinkButton runat="server" ID="lnkDiscontinuedServices" class="widget widget-hover-effect2" OnClick="lnkDiscontinuedServices_Click">
                                    <div class="widget-extra themed-background-danger">
                                        <h4 class="widget-content-light"><strong>Discontinued</strong> Services</h4>
                                    </div>
                                    <div class="widget-extra-full"><span class="h2 text-danger animation-expandOpen" runat="server" id="lblDiscontinuedServicesCount"></span></div>
                                </asp:LinkButton>
                            </div>
                            <div class="col-sm-6 col-lg-4">
                                <asp:LinkButton runat="server" ID="lnkAllServices" class="widget widget-hover-effect2" OnClick="lnkAllServices_Click">
                                    <div class="widget-extra themed-background-dark">
                                        <h4 class="widget-content-light"><strong>All</strong> Services</h4>
                                    </div>
                                    <div class="widget-extra-full"><span class="h2 themed-color-dark animation-expandOpen" runat="server" id="lblAllServicesCount"></span></div>
                                </asp:LinkButton>
                            </div>
                        </div>
                        <!-- END Quick Stats -->
                        ...
                        <div class="block full">
                            ...
                            <div class="block-title">
                                ...
                                <h2 runat="server" id="lblSearchDescription"><strong>All</strong> Services</h2>
                            </div>
                            ...
                            <div class="form-inline push-bit clearfix">
                                ...
                                <select id="selShow" visible="false" runat="server" class="form-control pull-right" size="1">
